...
http:
  ...
  base_server_url: "https://ota1.tusdev.com"
  get_device_path_file: '/api/ota/property/device/%s/file?path=%s&isRefresh=true&logType=CAN 日志'
  get_file_upload_tasks: '/api/ota/file/file-upload-tasks?vin=%s&originalName=%s&logType=CAN 日志&status=success,fail'
  create_file_upload_tasks: '/api/ota/property/%s/file-upload-tasks'
